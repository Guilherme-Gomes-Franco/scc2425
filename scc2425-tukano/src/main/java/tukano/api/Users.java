...
public interface Users {
	 ...
	 */
	Result<String> createUser(UserImp user);
	 ...
	 */
	Result<UserImp> getUser(String userId, String pwd);
	 ...
	 *         BAD_REQUEST - otherwise.
	 */
	Result<UserImp> updateUser(String userId, String pwd, UserImp user);
	 ...
	 *         BAD_REQUEST otherwise
	 */
	Result<UserImp> deleteUser(String userId, String pwd);
	 ...
	 *         BAD_REQUEST - otherwise.
	 */
	Result<List<UserImp>> searchUsers(String pattern);
}
